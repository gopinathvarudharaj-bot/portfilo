    ...
    <section id="home" className="relative pt-24 pb-16 md:pt-28 md:pb-24 bg-black cyber-grid overflow-hidden">
      ...
      <div className="max-w-7xl 2xl:max-w-[1550px] 3xl:max-w-[1800px] mx-auto px-3 sm:px-6 lg:px-8 2xl:px-12 relative z-10">
        ...
        <div className="relative text-center my-3 py-3 sm:my-4 sm:py-6 md:py-8 2xl:py-12 select-none">
          ...
          >
            <h1 className="font-display text-4xl xs:text-5xl sm:text-6xl md:text-7xl lg:text-8xl xl:text-[100px] 2xl:text-[124px] 3xl:text-[150px] font-black tracking-wide sm:tracking-wider md:tracking-widest leading-none text-neon-green uppercase text-gradient-green drop-shadow-[0_0_35px_rgba(34,197,94,0.45)] select-none text-center">
              PORTFOLIO
            </h1>
